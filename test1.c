...
int verificando_figas(char **tabu){
    //verificar linhas, colunas, diagonais e o empate com base nas regras do jogo 
...
//parte do main
int main(){
    char** tabu = (char **)malloc(3* sizeof(char*)); //esse for vai alocar a matriz usando o tamanho char 
    for(int i=0;i<3;i++){        
